...
1. Clone the repository to your local machine:
   ...
   ```bash
   git clone https://github.com/Porgramming-Hero-web-course/l2-b2-assignment-6-fronten-towhidulislamalif
   ```
